...
<ul class="breadcrumb push-down-0">
    ...
    <li class="active">Pesan Dihapus</li>
</ul>
<!-- END BREADCRUMB -->
<!-- START CONTENT FRAME -->
<div class="content-frame">
    ...
    <div class="content-frame-top">
        <div class="page-title">
            <h2><span class="fa fa-trash-o"></span> Pesan Dihapus</h2>
        </div>
    ...
    <div class="content-frame-left">
        <div class="block">
            <div class="list-group border-bottom">
                ...
                <a href="<?php echo base_url() ?>admin/send" class="list-group-item"><span class="fa fa-rocket"></span> Pesan Terkirim</a>
                <a href="<?php echo base_url() ?>admin/delete" class="list-group-item active"><span class="fa fa-trash-o"></span> Pesan Dihapus <span class="badge badge-default">1.4k</span></a>
            </div>
        </div>
    </div>
