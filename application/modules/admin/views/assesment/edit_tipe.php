...
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" action="<?php echo base_url() ?>admin/update_tipe" method="POST">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php  echo base_url() ?>admin/edit_tipe/<?php echo $t->id_tipe ?>" class="btn btn-sm btn-success"><span class="fa fa-edit"></span> Edit </a> <a href="<?php  echo base_url() ?>admin/del_tipe/<?php echo $t->id_tipe ?>" class="btn btn-sm btn-danger"><span class="fa fa-minus-square"></span> Hapus</a> </td>
                            </tr>
                            <?php  $no++;  }
                            ?>
                        </tbody>
