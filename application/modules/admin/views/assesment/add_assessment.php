...
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="block">
                <form id="jvalidate" action="<?php echo base_url() ?>admin/save_assesment" role="form" class="form-horizontal" method="POST">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="label-control col-md-2">Jumlah</label>
                                                <div class="col-md-2">
                                                    <input type="text" min="0" name="jml_pengungsi" class="form-control" disabled="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
