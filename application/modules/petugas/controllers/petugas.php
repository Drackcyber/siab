...
class petugas extends MX_Controller {
	...
	**/
	...
	public function edit_assessment($id){
		...
		$marker                                 = array();
		$marker['position']                     = "$b->lat,$b->lng";
		$marker['infowindow_content']           = "<b>$b->nm_bencana</b> <br><br> <i> Alamat : $b->lokasi_bencana <br> Tanggal : $b->tgl_kejadian</i> ";
		$this->googlemaps->add_marker($marker);
		...
		$data['tipe'] = $this->db_utama->show_all('siab_tipe');
		$this->template->render('assesment/edit_assessment', $data);
	}
