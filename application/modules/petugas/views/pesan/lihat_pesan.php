    ...
    <div class="content-frame-left">
        <div class="block">
            <div class="list-group border-bottom">
                <a href="<?php echo base_url() ?>petugas/inbox" class="list-group-item"><span class="fa fa-inbox"></span> Inbox</a>
                <a href="<?php echo base_url() ?>petugas/sent" class="list-group-item"><span class="fa fa-rocket"></span> Sent</a>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group push-up-30">
                    ...
                    <form role="form" action="<?php echo base_url() ?>petugas/reply" method="POST">
