    ...
    <div class="page-content-wrap">
        ...
        <div class="page-content-holder this-animate" data-animate="fadeIn">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul>
                        <?php $i=1; foreach ($assesment as $a) { ?>
                            <li>
                                <a href="<?php echo base_url() ?>home/detail_bencana/<?php echo $a->id_assesment ?>" title="Klik untuk detail"><?php echo $a->nm_bencana ?></a>, 
                                (<?php echo $a->waktu ?> WIB, <?php echo $a->tgl_kejadian ?>)
                            </li>
                        <?php $i++; } ?>
                        </ul>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5 class="text-center"><strong>Grafik Bencana di Gunungkidul</strong></h5>
                    </div>
                    <div class="panel-body">
                        <div style="width: 80%">
                            <center>
