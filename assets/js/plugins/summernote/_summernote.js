    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          help: 'Dimensi maksimal gambar adalah 640px',
          url: 'Image URL',
          remove: 'Remove Image'
        },
        link: {
...
/*==========  MENGATUR GAMBAR PADA TOOLBAR SUMMERNOTE  ==========*/
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body =
                   ...
                   '</div>' +
                   '<span class="help-block">' + lang.image.help + '</span>' +
                   '<hr />' +
                   '<h5>' + lang.image.url + '</h5>' +
                   '<input class="note-image-url form-control span12" type="text" placeholder="Image url"/>';
